        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-[#121212] border border-gray-200 dark:border-[#222] rounded-2xl p-5 shadow-sm">
            <div className="flex justify-between items-baseline mb-1">
              ...
              <span className={`text-xs tabular-nums ${title.length > 90 ? "text-red-400" : "text-gray-400 dark:text-gray-500"}`}>
                {title.length} / 100
              </span>
            </div>
          ...
          <div className="bg-white dark:bg-[#121212] border border-gray-200 dark:border-[#222] rounded-2xl p-5 shadow-sm">
            <div className="flex justify-between items-baseline mb-1">
              ...
              <span className={`text-xs tabular-nums ${jobTitle.length > 90 ? "text-red-400" : "text-gray-400 dark:text-gray-500"}`}>
                {jobTitle.length} / 100
              </span>
            </div>
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-3">
              The exact role you're applying for, e.g. "Senior Software Engineer".
            </p>
            <input
              type="text"
              value={jobTitle}
          ...
          <div className="bg-white dark:bg-[#121212] border border-gray-200 dark:border-[#222] rounded-2xl p-5 shadow-sm">
            <div className="flex justify-between items-baseline mb-1">
              ...
              <span className={`text-xs tabular-nums ${jobDescription.length > 4800 ? "text-red-400" : "text-gray-400 dark:text-gray-500"}`}>
          ...
          <div className="bg-white dark:bg-[#121212] border border-gray-200 dark:border-[#222] rounded-2xl p-5 shadow-sm">
            <div className="flex justify-between items-baseline mb-1">
              ...
              <span className={`text-xs tabular-nums ${selfDescription.length > 1900 ? "text-red-400" : "text-gray-400 dark:text-gray-500"}`}>
                {selfDescription.length} / 2000
              </span>
            </div>
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-3">
              Your experience, strengths, and key projects the AI should factor in.
            </p>
            <textarea
